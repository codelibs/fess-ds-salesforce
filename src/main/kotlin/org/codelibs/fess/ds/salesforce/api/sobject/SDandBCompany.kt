...
import org.codelibs.fess.ds.salesforce.api.sobject.SDandBCompany.Field.*

/** D&B 企業 */
data class SDandBCompany(
        override val title: String = Name.name,
        override val contents: List<String> = listOf(Name, DunsNumber, Phone, Fax, URL, LocationStatus, Description).map { it.name }
) : SearchLayout {
    enum class Field {
        /** D&B 企業 ID */
        Id,
