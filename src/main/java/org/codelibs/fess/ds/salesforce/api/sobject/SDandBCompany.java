...
public class SDandBCompany extends SearchLayout {
    ...
    protected static final List<String> contents = Stream.of(Field.Name, Field.DunsNumber, Field.Phone,
            Field.Fax, Field.URL, Field.LocationStatus, Field.Description).map(Enum::name).collect(Collectors.toList());
